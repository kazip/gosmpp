...
[![](https://github.com/kazip/gosmpp/workflows/Build/badge.svg)]()
[![Go Report Card](https://goreportcard.com/badge/github.com/kazip/gosmpp)](https://goreportcard.com/report/github.com/kazip/gosmpp)
...
[![godoc](https://img.shields.io/badge/docs-GoDoc-green.svg)](https://godoc.org/github.com/kazip/gosmpp)
...
## Installation
```
go get -u github.com/kazip/gosmpp
```
...
- Full example could be found: [here](https://github.com/kazip/gosmpp/blob/master/example)
  - In this example, you should run smsc first:
	...
	./smsc &
	```
    - Run smpp client in the example: https://github.com/kazip/gosmpp/blob/master/example/main.go
    ```bash
